...
?>
	...
	?>
                        ...
                        <li class="dropdown mega-dropdown">
                           <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><? echo MENU_FILMES; ?> <span class="fa fa-chevron-down pull-right"></span></a>
                           <ul class="dropdown-menu">
